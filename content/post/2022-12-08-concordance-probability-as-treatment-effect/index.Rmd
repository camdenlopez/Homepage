...
(This seems to explain the choice of "common language" to name it.) The alternatives they mention are Cohen's *d* and several others I wasn't familiar with. Indeed, one reason why I thought about the AUROC as potentially useful beyond diagnostic or predictive accuracy is that it seems intuitive and easy to explain to non-statisticians.
